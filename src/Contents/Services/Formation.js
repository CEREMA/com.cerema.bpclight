Formation = {
	...
	getAll2: function(o,cb) {
		var db=Formation.using('db');
		console.log('SELECT * FROM Recapitulatif, Type_formation, frequence WHERE Recapitulatif.type_formation=Type_formation.id_formation AND Recapitulatif.Kage ="'+o.Kage+'" ORDER BY 3');
